...
def MINIST_Fashion_with_3_layers(n_epochs, batch_size_train, dropout_rate, learning_rate, num_filters_1, num_filters_2):
    # setting up hyper parameters
    batch_size_test = 1000
    momentum = 0.5
    log_interval = 10
    ...
    time_spent = 0
    for epoch in range(1, n_epochs + 1):
        print("Epoch times with 3 layers: ", epoch)
        train(epoch)
        accuracy, time_spent = test()
        print()
...
if __name__ == '__main__':
    ...
    accuracy, time_spent = MINIST_Fashion_with_3_layers(15, 128, 0.001, 0.11,
                                                        40, 80)
    print(f"the best combined result with 3 layers: accuracy is {accuracy}, and time spent is {time_spent}")
